...
| --- | --- |
| Introduction | [Introduction.html](https://mehmoodkhans.github.io/healthcare-analytics/html/Introduction.html) |
| Section A — Patient & Care Quality | [Section_A.html](https://mehmoodkhans.github.io/healthcare-analytics/html/Section_A.html) |
| Section B — Operations & Capacity | [Section_B.html](https://mehmoodkhans.github.io/healthcare-analytics/html/Section_B.html) |
| Section C — Financial & Revenue Cycle | [Section_C.html](https://mehmoodkhans.github.io/healthcare-analytics/html/Section_C.html) |
| Section D — Risk, Safety & Compliance | [Section_D.html](https://mehmoodkhans.github.io/healthcare-analytics/html/Section_D.html) |
| Section E — System Performance & Scalability | [Section_E.html](https://mehmoodkhans.github.io/healthcare-analytics/html/Section_E.html) |
| Section F — Strategic Recommendations | [Section_F.html](https://mehmoodkhans.github.io/healthcare-analytics/html/Section_F.html) |
...
├── streamlit-dashboard/             # Interactive companion dashboard
│   ├── README.md                    # Dashboard-specific setup & usage guide
│   ├── streamlit_app.py             # The live dashboard app
│   ├── export_for_streamlit.py      # Generates data/ from the full database
│   ├── requirements.txt             # Python dependencies
│   └── data/                        # Pre-aggregated CSVs (small, committed)
...
| Streamlit | 1.36+ | Interactive dashboard (see streamlit-dashboard/) |
...
- **Interactive dashboards:** Streamlit + Plotly, live data-driven visualizations
